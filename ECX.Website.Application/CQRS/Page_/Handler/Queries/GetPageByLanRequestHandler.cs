...
{
    public class GetPageByLanRequestHandler : IRequestHandler<GetPageByLanRequest, BaseCommonResponse>
    {
        ...
        public GetPageByLanRequestHandler(IPageRepository pageRepository, IMapper mapper)
        {
            _pageRepository = pageRepository;
            _mapper = mapper;
        }
        public async Task<BaseCommonResponse> Handle(GetPageByLanRequest request, CancellationToken cancellationToken)
        {
            var response = new BaseCommonResponse();
            var data = await _pageRepository.GetPageByLangId(request.Id);
