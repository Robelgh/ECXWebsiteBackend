...
{
    /// <inheritdoc />
    public partial class commonV : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EduStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FileName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LangId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CommodityGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImgName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_complainFeedBacks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductionYear = table.Column<double>(type: "float", nullable: false),
                    ...
                    VolumeInLot = table.Column<double>(type: "float", nullable: false),
                    VolumeInQuintal = table.Column<double>(type: "float", nullable: false),
                    PercentageChange = table.Column<double>(type: "float", nullable: false),
                    PreviousClosing = table.Column<double>(type: "float", nullable: false),
                    DateKey = table.Column<double>(type: "float", nullable: false),
                    tday = table.Column<double>(type: "float", nullable: false),
                    tmonth = table.Column<double>(type: "float", nullable: false),
                    tyear = table.Column<double>(type: "float", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParentLookups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractFiles_Commodities_CommodityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LangId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParentLookupId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImgName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PageCatagories_ParentLookups_ParentLookupId",
                        column: x => x.ParentLookupId,
                        principalTable: "ParentLookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LangId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PageCatagoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImgName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Page_PageCatagories_PageCatagoryId",
                        column: x => x.PageCatagoryId,
                        principalTable: "PageCatagories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vacancy_PageCatagories_PageCatagoryId",
                        column: x => x.PageCatagoryId,
                        principalTable: "PageCatagories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "90284d54-e802-4daf-a84a-de3e536a6fcc", "c6b94423-577f-40d6-ab1f-5dd0581a4aef", "Administrator", "ADMINISTRATOR" },
                    { "db4e661b-bcdf-461c-a5fe-2ffd128e659b", "caa1522d-bf39-4b34-b3ac-424a6dafb26d", "Visitor", "VISITOR" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ContractFiles_CommodityId",
                table: "ContractFiles",
                column: "CommodityId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Page_PageCatagoryId",
                table: "Page",
                column: "PageCatagoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PageCatagories_ParentLookupId",
                table: "PageCatagories",
                column: "ParentLookupId");

            migrationBuilder.CreateIndex(
                name: "IX_Vacancy_PageCatagoryId",
                table: "Vacancy",
                column: "PageCatagoryId");
        }
